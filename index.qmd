...
## Topic 1: Introduction to `teal`
> (5 minutes) · status:  TODO

* What is `teal`?
* What `teal` can be used for?
* What is the `teal` framework - other packages from the `teal` family.

## Topic 2: How to install the `teal` framework? 

> (2 minutes) · status:  TODO

* Installation of `teal` and its dependencies - code samples

## Topic 3: Launching a simple `teal` application
